        ...
        <div className={LANDINGCSS.landingModalContent}>
          <div className="callToAction">
            ...
            <p>
              ...
              fugiat ea aspernatur dolorum quasi laboriosam soluta laudantium
              recusandae vel suscipit eveniet, voluptates doloremque facilis
              quibusdam iure mollitia quod provident, obcaecati molestias. At
              reiciendis, nulla amet, libero aspernatur nisi quas fugiat esse
              sit accusantium provident consequatur numquam natus possimus.
              Tempore eaque illo delectus temporibus distinctio architecto
              minima modi iusto inventore porro!
            </p>
          ...
          <div className={LANDINGCSS.blogPosts}>
            ...
            <Link className={LANDINGCSS.viewMore} to="/posts">
              View More
            </Link>
          </div>
        </div>
